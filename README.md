...
|---------------------------|-----------------|---------------|
| UCSBDiningCommonsMenuItem | Forrest Zhou    | linzezhou     |
| UCSBOrganization          | Hannah Zhang    | hannahz0      |
| RecommendationRequest     | Steven Liu      | stevenliu2002 |
| MenuItemReview            | Hannya Yan      | hannyaYan     |
| HelpRequest               | Annika Damstedt | acdamstedt    |
| Articles                  | Shelly Zhu      | zhushelly     |

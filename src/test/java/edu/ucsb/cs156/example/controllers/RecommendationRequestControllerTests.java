...
public class RecommendationRequestControllerTests extends ControllerTestCase {
        ...
        @Test
        public void an_admin_user_can_post_a_new_recommendationarequest() throws Exception {
                // arrange
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/recommendationrequest/post?requesterEmail=yuchenliu735@ucsb.edu&professorEmail=pconrad@ucsb.edu&explanation=testing&dateRequested=2022-01-03T00:00:00&dateNeeded=2022-03-11T00:00:00&done=true")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                // arrange
                LocalDateTime ldt3 = LocalDateTime.parse("2002-01-03T00:00:00");
                LocalDateTime ldt4 = LocalDateTime.parse("2003-01-03T00:00:00");
        ...
        public void admin_can_edit_an_existing_recommendationrequest() throws Exception {
                ...
                RecommendationRequest recommendationRequestEdited = RecommendationRequest.builder()
                                .requesterEmail("linze_zhou@ucsb.edu")
